...
> 대안: `bash <(curl -fsSL https://raw.githubusercontent.com/uzysjung/uzys-claude-harness/main/install.sh)` — 기존 docs 호환용 wrapper. 내부에서 동일 `npx` 호출. `npx`가 PATH에 없는데 Node 20+는 있는 환경에 사용.
