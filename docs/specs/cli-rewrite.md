...
> **Related**: `docs/specs/codex-compat.md` (Codex 호환 1차, v26.37.0 완료) — 본 작업은 Codex 호환 인프라(`scripts/claude-to-codex.sh`, `templates/codex/`)는 **그대로 유지**하되 진입 CLI만 재작성.
...
- **AC3 — 9 Track + Codex 호환 보존**: 9 Track 무인 fresh install 9/9 PASS (현 v26.37.0 등가). `--cli codex` 경로도 작동(내부에서 `scripts/claude-to-codex.sh` 호출 또는 TS 포팅).
